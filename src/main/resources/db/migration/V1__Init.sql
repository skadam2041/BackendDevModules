...
(
    ...
    CONSTRAINT pk_jpa_category PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT pk_jpa_product PRIMARY KEY (id)
);

CREATE TABLE jpa_rating
(
    id BIGINT NOT NULL,
    rate DOUBLE NOT NULL,
    count DOUBLE NOT NULL,
    CONSTRAINT pk_jpa_rating PRIMARY KEY (id)
);
...
ALTER TABLE jpa_product
    ADD CONSTRAINT FK_JPA_PRODUCT_ON_CATEGORY FOREIGN KEY (category_id) REFERENCES jpa_category (id);

ALTER TABLE jpa_product
    ADD CONSTRAINT FK_JPA_PRODUCT_ON_RATING FOREIGN KEY (rating_id) REFERENCES jpa_rating (id);
